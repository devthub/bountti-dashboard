...
const allPermissions = [...BOUNTTI_PERMISSIONS] as BounttiPermission[];

export const BOUNTTI_ROLE_CONFIG = {
  'super-admin': {
    label: 'Super Admin',
    initials: 'SA',
    displayName: 'Alex Thornton',
    permissions: allPermissions,
    nav: ['dashboard', 'apm', 'users', 'affiliates', 'merchants', 'reports', 'settings', 'permissions'],
  },
  admin: {
    label: 'Admin',
    initials: 'AD',
    ...
    nav: ['dashboard', 'apm', 'users', 'affiliates', 'merchants', 'reports', 'settings'],
  },
  'affiliate-l1': {
    label: 'Affiliate L1',
    initials: 'L1',
  ...
  merchant: {
    ...
    permissions: ['dashboard:view', 'merchants:view-own', 'reports:view-own-transactions', 'settings:view'],
    nav: ['dashboard', 'merchants', 'reports', 'settings'],
  },
} satisfies Record<BounttiRole, BounttiRoleConfig>;

export function hasBounttiPermission(role: BounttiRole, permission: BounttiPermission) {
